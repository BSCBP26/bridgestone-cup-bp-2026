...
const idToEn = new Map(Object.entries({
  ...
  'Sambutan Acara': 'Exhibition Match',
  'Kelola nama, jabatan, pesan sambutan, serta foto perwakilan acara.': 'Manage the three Exhibition Match panels, copy, photos, order, and publishing.',
  ...
  'Publish': 'Publish',
  'Edit': 'Edit',
  'PENGATURAN SAMBUTAN': 'EXHIBITION MATCH SETTINGS',
  'Tambah Greeting': 'Add Exhibition Match',
  'Foto': 'Photo',
  'Nama': 'Name',
  ...
  'Simpan Greeting': 'Save Exhibition Match',
  'SAMBUTAN TERSIMPAN': 'EXHIBITION MATCH SAVED',
  'Greeting Tersimpan': 'Saved Exhibition Match',
  'Memuat greeting…': 'Loading Exhibition Match…',
  'Belum ada greeting tersimpan.': 'No Exhibition Match saved yet.',
